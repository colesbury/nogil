...
func_new(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyObject_TypeCheck(fastargs[0], &PyCode2_Type)) {
        _PyArg_BadArgument("function", "argument 'code'", (&PyCode2_Type)->tp_name, fastargs[0]);
        goto exit;
    }
    code = (PyCodeObject2 *)fastargs[0];
...
/*[clinic end generated code: output=a805f50f94f0e5c4 input=a9049054013a1b77]*/
