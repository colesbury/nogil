...
_imp__fix_co_filename(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyObject_TypeCheck(args[0], &PyCode2_Type)) {
        _PyArg_BadArgument("_fix_co_filename", "argument 1", (&PyCode2_Type)->tp_name, args[0]);
        goto exit;
    }
    code = (PyCodeObject2 *)args[0];
...
/*[clinic end generated code: output=b5e5546d672b2bbb input=a9049054013a1b77]*/
