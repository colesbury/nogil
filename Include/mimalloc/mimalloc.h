...
mi_decl_nodiscard mi_decl_export mi_decl_restrict void* mi_heap_malloc_array(mi_heap_t* heap, size_t wsize, size_t *usable) mi_attr_noexcept mi_attr_malloc mi_attr_alloc_size(2);
